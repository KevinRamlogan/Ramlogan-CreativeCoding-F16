...
function filling(){
	...
	if (mouseDeltaX<10){
	setColors();
		fill(random(colorOne,colorOne),colorTwo,ColorThree);
}
	if(mouseDeltaX>50){
	setColors();
		fill(0);
...
mouseSpeed();
	if (mouseDeltaX<49){
	setColorsTwo();
		fill(random(colorOne,colorOne),random(colorThree,colorThree),random(colorTwo,colorTwo));
}
	if(mouseDeltaX>50){
	setColorsTwo();
		fill(255);}
	...
	if (mouseDeltaY<49){
	setColorsTwo();
	//constant changing colors -grey boxes 
		fill(random(colorOne,200),colorThree,200);
	}
}
function fillingThree(){
	...
	if (mouseDeltaX<49){
	setColorsThree();
		fill(random(colorOne,colorTwo,colorThree));
}
	if(mouseDeltaX>50){
	setColorsThree();
		fill(255);}
...
function shapeMoving(){
	...
	ellipse(recSize,50, recSizeY,100);
}
...
function shapeField(){
	...
	for (i=1;i<100;i++){
	rotAmount=map(i,10,width,0,random(1,10)*PI);
	fillingTwo();
	rotate(rotAmount);
...
function shapeFieldTwo(){
	for (i=1;i<100;i++){
	rotAmount=map(i,10,width,0,random(.05,1)*PI);
	//filling();
	rotate(rotAmount);
	recSize= map(mouseX,0,500,0,50);
